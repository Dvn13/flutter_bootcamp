...
class TodoDetailView extends StatelessWidget {
  ...
  TodoDetailView({super.key, required this.todoModel});

  var todoText = TextEditingController();

  @override
  Widget build(BuildContext context) {
    todoText.text = todoModel.name;
    var id = todoModel.id;
    ...
    return Scaffold(
      ...
      body:
          buildBody(secondaryColor, primaryColor, secondaryColor2, context, id),
    );
  }
  ...
  Container buildBody(Color secondaryColor, Color primaryColor,
      Color secondaryColor2, BuildContext context, int id) {
    return Container(
